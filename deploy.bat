...
@set RUNNER=%0
@set CPAN_PACKAGES=DBI DBI::Profile Algorithm::Diff SQL::Abstract JSON::XS Apache2::Request XML::Parser::Expat Template Authen::Passphrase Text::CSV Test::Exception
