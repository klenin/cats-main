...
my $main_routes = {
    ...
    contest_sites => [ \&CATS::UI::Sites::contest_sites_frame,
        add => bool, mass_delete => bool, delete => integer, check => array_of integer, with_org => integer,
    ...
    contest_wikis => [ \&CATS::UI::ContestWikis::contest_wikis_frame,
    ...
    problem_text_import => [ \&CATS::UI::ProblemHistory::problem_text_import_frame,
        pid => required integer, do_import => bool, text => undef, method => ident,
    ],
    ...
    users => [
        ...
        delete_user => integer, saved => integer,
    ...
    snippets => [ \&CATS::UI::Snippets::snippets_frame,
        delete => integer, saved => integer, sel => array_of integer, delete_sel => bool, ],
    ...
    rank_table_content => [ \&CATS::UI::RankTable::rank_table_content_frame,
        ...
        @CATS::UI::RankTable::router_params,
    ],
    ...
    rank_table_icpc_export => [ \&CATS::UI::RankTable::rank_table_icpc_export_frame,
        (map { $_ => bool0 } @CATS::UI::RankTable::router_bool_params),
        @CATS::UI::RankTable::router_params,
        icpc_teams => str,
        do_export => bool,
    ...
    wiki_edit => [ \&CATS::UI::Wiki::wiki_edit_frame,
        $CATS::UI::Wiki::text_form->route, settings_rows => integer, sync => bool, ],
...
my $api_judge_routes = {
    ...
    api_judge_get_problem_tags => [ \&CATS::ApiJudge::get_problem_tags,
        pid => integer, cid => integer, aid => integer, ],
