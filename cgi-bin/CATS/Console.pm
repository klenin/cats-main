...
sub build_query {
    ...
    my %parts_sql = (
        run => qq~
            ...
            R.submit_time,
            R.submit_time - C.start_date AS since_start,
            R.id AS id,
        ...
        question => qq~
            ...
            Q.submit_time,
            Q.submit_time - C.start_date AS since_start,
            Q.id AS id,
            $dummy_req_block,
            $no_de,
        ...
        message => qq~
            ...
            E.ts AS rank,
            E.ts AS submit_time,
            E.ts - C.start_date AS since_start,
            M.id AS id,
            $dummy_req_block,
            $no_de,
        ...
        (map { +"contest_$contest_date_types[$_]" => qq~
            ...
            C.$contest_date_types[$_]_date - C.start_date AS since_start,
            C.id AS id,
