...
BEGIN
    ...
    BEGIN
        ...
        UPDATE tests SET generator_id = :id_ WHERE generator_id = :old_id;
        UPDATE tests SET input_validator_id = :id_ WHERE input_validator_id = :old_id;
        UPDATE tests SET std_solution_id = :id_ WHERE std_solution_id = :old_id;
    END
END^
